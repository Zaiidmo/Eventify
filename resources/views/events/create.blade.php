...
@section('content')
    <section>
        <div class="flex flex-col max-w-screen-xl mx-auto pt-32">
            ...
            <form class="mx-8 my-8 lg:mx-0 font-poppins font-semibold tracking-wide" action="{{ route('events.store') }}"
                ...
                <div class="flex flex-row justify-between mt-8 gap-8">
                    <div class="w-full">
                        ...
                        <input type="text" placeholder="Eventify" name="title"
                ...
                <div class="mt-8">
                    <label for="event-description" class="block text-sm text-gray-500 dark:text-gray-300">Event
                        Description</label>
                ...
                <div class="flex flex-row justify-between mt-8 gap-8">
                    <div class="flex justify-between w-full gap-8">
                        ...
                        <div>
                            <label for="Event time" class="block text-sm text-gray-500 dark:text-gray-300">Event time</label>
                            <input type="time" name="time" class="block mt-2 w-full placeholder-gray-500 rounded-lg border border-gray-200 bg-gray-700 px-5 py-2.5 text-subtle focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
                        </div>
                ...
                <div class="mt-8 w-full">
                    ...
                    <label for="poster"
                        ...
                        <p class="mt-2 text-xs tracking-wide text-gray-500 dark:text-gray-400">Upload or darg & drop your
                            file JPG, JPEG, PNG. </p> <input name="poster" id="poster" type="file" class="hidden" />
                    </label>
                </div>
