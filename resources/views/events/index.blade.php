        ...
        <div class="w-full bg-center bg-cover h-[28rem] lg:h-[38rem]"
            ...
            <div class=" w-full h-full bg-gray-900/40">
                <div class=" flex flex-col items-center justify-center h-full text-left max-w-screen-xl mx-auto">
                    ...
                    <p class="text-xl lg:text-4xl font-bold font-yellowTTail text-white text-center">Explore the <span class="text-secondary">vibrant events</span> happening locally and globally.</p>
                    <div method="" id="search_bar" class="relative mb-8 w-full">
                        <label class="mx-2 lg:mx-auto mt-8 relative bg-white min-w-sm max-w-2xl flex flex-col md:flex-row items-center justify-center border py-2 px-2 rounded-2xl gap-2 shadow-2xl focus-within:border-gray-300"
                            for="search-bar">
