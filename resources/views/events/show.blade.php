...
<section class="pt-32">
    <div class="gap-6 items-center py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
        <img class="border-2 border-subtle p-8 w-screen rounded-3xl" src="{{ asset('storage/uploads/events/' . $event->poster)}}" alt="">
    </div>
    <div class="gap-6 items-center py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
    ...
    <div class="gap-6 items-center py-8 px-4 mx-auto max-w-screen-xl">
        <div class="flex flex-col gap-8 items-start">
            ...
            <div class="flex flex-col gap-4 justify-between">
                <div class="flex justify-start items-center  gap-4">
                    <img class="rounded-full w-24" src="{{asset('storage/uploads/profiles/' . $event->user->avatar)}}" alt="User photo">
