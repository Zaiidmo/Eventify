...
<body>
    <main class="p-4">
        <div class="flex text-zinc-50 h-96">
            <div class="h-full w-3/12 bg-zinc-900 flex items-center justify-center px-8 rounded-l-3xl">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="140px" height="140px"
            ...
            <div class="h-full py-8 px-10 bg-zinc-900 flex-grow rounded-r-3xl flex flex-col">
                <h1 class="text-center text-bold font-trade text-7xl"> {{$event->title}} </h1>
                <div class="grid grid-cols-4 my-auto justify-between">
                    <div class="flex flex-col col-span-2">
                        <h3 class="text-5xl font-supermercado">{{$event->date}}</h3>
                        <h3 class="text-4xl font-supermercado">17:45</h3>
                        <h5 class="text-2xl font-supermercado">{{$event->location}}</h5>
                    </div>
                    <div class="flex flex-col col-span-1">
                        <div>
                            <h3 class="text-2xl font-buttons">Hosted By :</h3>
                            <h3 class="text-2xl font-supermercado"> {{$event->user->name}} </h3>
                        </div>
                        <div>
                            <h3 class="text-2xl font-buttons">Category :</h3>
                            <h3 class="text-2xl font-supermercado"> {{$event->category->name}} </h3>
                        </div>
                    </div>
                    <div class="flex flex-col col-span-1">
                        <div>
                            <h3 class="text-2xl font-buttons">Ticket To :</h3>
                            <h3 class="text-2xl font-supermercado"> {{$user->name}}</h3>
                        </div>
                        <div>
                            <h3 class="text-2xl font-buttons">Price :</h3>
                            <h3 class="text-2xl font-supermercado"> {{$event->ticket_price}} $</h3>
                        </div>
                    </div>
                </div>
                <div class="text-center paymborder-gray-600 border-t w-full">
                    <span class="text-center text-gray-400">© 2024 Eventify. All Rights Reserved.</span>
                </div>
            </div>
