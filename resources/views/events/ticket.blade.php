            ...
            <section class="w-full flex-grow bg-zinc-200 flex items-center justify-center p-4">
                <div class="flex w-full max-w-3xl text-zinc-50 h-64">
                    ...
                    <div class="h-full py-8 px-10 bg-zinc-900 flex-grow rounded-r-3xl flex flex-col">
                        <h1 class="text-center text-bold font-trade text-7xl"> Eventify </h1>
                        <div class="grid grid-cols-3 my-auto">
                            ...
                            <div class="flex flex-col">
                                <span class="text-xs text-zinc-400">Hosted By :</span>
                                <span class="font-mono">Host</span>
                                <span class="text-xs text-zinc-400">Ticket Price</span>
                                <span class="font-mono">100 $</span>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-xs text-zinc-400">Ticket Owner :</span>
                                <span class="font-mono">Owner  Name</span>
                                <span class="text-xs text-zinc-400">Status</span>
                                <span class="font-mono">statuus<span>
                            </div>
                        </div>
                        <div class="flex justify-between  items-center border-t w-full">
                            <span class="text-xs text-zinc-400">Location</span>
                            <span class="font-mono">Somewhere on planet Earth</span>
                        </div>
