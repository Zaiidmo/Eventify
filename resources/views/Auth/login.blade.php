                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="{{ route('login')}}" method="POST">
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="{{ route('forget.password.view')}}" class="text-sm text-secondary hover:underline ">Lost Password?</a>
                            </div>
                            ...
                            <div class="text-sm text-center font-medium font-poppins text-subtle">
                                New To Eventify? <a href="/register" class="text-secondary hover:underline ">Create account</a>
                            </div>
                        </form>
                    </div>
                </div>
