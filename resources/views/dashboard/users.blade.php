        ...
        <div class=" w-full h-full bg-gray-900/40">
            <div id="tableData" class="container px-4 pt-36 ml-auto">
                <div class="flex flex-col lg:flex-row w-full justify-center items-center gap-x-3">
                    <h1 class="text-4xl md:text-6xl font-supermercado font-medium text-subtle ">Registered <span class="text-primary">Users</span></h1>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead class="bg-gray-950">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white">Email address</th>
            
                                            <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white">Registration Date</th>
                                    ...
                                    <tbody class="bg-black divide-y divide-gray-700  ">
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">9802/2212</td>
